...
export const Home = () => {
  return (
    <div className="relative flex flex-row w-full h-[800px] ">
      <div className="h-[720px] flex flex-row">
        {/* Left side  */}
        <div className=" h-full w-[50%] flex flex-col justify-end md:ml-[66px]">
        ...
        {/* Right Side */}
        <div className="bg-hero bg-no-repeat h-[720px] w-[50%] flex flex-col justify-end ">
          <div className=" md:h-[100px] bg-transparent rounded-[32px] flex flex-row mb-[30px] ">
            <div className="rounded-[32px] bg-white md:w-[300px] h-full ml-[30px] flex items-center">
              <div className="w-[35%] md:h-[56px] flex flex-row bg-no-repeat relative ">
                <div className="absolute rounded-full bg-rec3 h-[56px] w-[56px] z-10 "></div>
                <div className="absolute rounded-full bg-rec2 h-[56px] w-[56px] left-4 z-20"></div>
                <div className="absolute rounded-full bg-rec1 h-[56px] w-[56px] left-6 z-30"></div>
              </div>
              <div className=" w-[65%] md:h-[46px] flex flex-col items-start ml-3">
                <h1 className="text-[#1B1C57] font-bold md:text-[16px] text-[8px] flex items-start">
                  {" "}
                  1K+ People
                </h1>
            ...
            <div className="rounded-[32px] bg-white md:w-[200px] h-full ml-[20px] flex items-center">
